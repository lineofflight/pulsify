# Data Kiosk Query Processing Finished

`DATA_KIOSK_QUERY_PROCESSING_FINISHED` · Seller Central · listing context
...
function handle(event, context) {
  // No-op by default. DataKiosk results are processed automatically.
...
| `NotificationType` | string | `DATA_KIOSK_QUERY_PROCESSING_FINISHED` |
| `NotificationVersion` | string | `1.0` |
| `Payload` | object |  |
| `Payload.AccountId` | string | `A1EXAMPLE00001` |
| `Payload.DataDocumentId` | string | `00000000-0000-0000-0000-000000000000` |
| `Payload.Pagination` | null |  |
| `Payload.ProcessingStatus` | string | `DONE` |
| `Payload.Query` | string | `query { analytics_salesAndTraffic_2024_11_15 { salesAndTrafficByAsin(startDate: "2024-11-01" endDate: "2024-11-15" aggregateBy: SKU) { endDate startDate } } }` |
| `Payload.QueryId` | string | `00000000-0000-0000-0000-000000000000` |
...
```json
{
  ...
  "Payload": {
    ...
    "Query": "query { analytics_salesAndTraffic_2024_11_15 { salesAndTrafficByAsin(startDate: \"2024-11-01\" endDate: \"2024-11-15\" aggregateBy: SKU) { endDate startDate } } }",
    "ProcessingStatus": "DONE",
    "DataDocumentId": "00000000-0000-0000-0000-000000000000",
    "Pagination": null
  }
}
```
