# Listings Item Status Change

`LISTINGS_ITEM_STATUS_CHANGE` · Seller Central · listing context
...
| `NotificationType` | string | `LISTINGS_ITEM_STATUS_CHANGE` |
| `NotificationVersion` | string | `1.0` |
| `Payload` | object |  |
| `Payload.Asin` | string | `B00EXAMPLE01` |
| `Payload.CreatedDate` | string | `2024-01-15T10:30:00.000Z` |
