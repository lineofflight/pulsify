...
`REPORT_PROCESSING_FINISHED` · Seller Central · listing context
...
function handle(event, context) {
  // No-op by default. Report downloads are processed automatically.
...
| Path | Type | Example |
| --- | --- | --- |
| `EventTime` | string | `2026-07-17T09:30:00.000Z` |
...
| `NotificationMetadata.PublishTime` | string | `2026-07-17T09:30:00.000Z` |
| `NotificationMetadata.SubscriptionId` | string | `00000000-0000-0000-0000-000000000000` |
| `NotificationType` | string | `REPORT_PROCESSING_FINISHED` |
| `NotificationVersion` | string | `2020-09-04` |
| `Payload` | object |  |
| `Payload.ReportProcessingFinishedNotification` | object |  |
| `Payload.ReportProcessingFinishedNotification.AccountId` | string | `A1EXAMPLE00001` |
| `Payload.ReportProcessingFinishedNotification.ProcessingStatus` | string | `DONE` |
| `Payload.ReportProcessingFinishedNotification.ReportDocumentId` | string | `amzn1.spdoc.1.3.na.00000000-0000-0000-0000-000000000000` |
| `Payload.ReportProcessingFinishedNotification.ReportId` | string | `12345678901` |
| `Payload.ReportProcessingFinishedNotification.ReportType` | string | `GET_MERCHANT_LISTINGS_ALL_DATA` |
| `Payload.ReportProcessingFinishedNotification.SellerId` | string | `A1EXAMPLE00001` |
...
```json
{
  ...
  "Payload": {
    "ReportProcessingFinishedNotification": {
      ...
      "ReportDocumentId": "amzn1.spdoc.1.3.na.00000000-0000-0000-0000-000000000000"
    }
  }
}
```
