# Branded Item Content Change

`BRANDED_ITEM_CONTENT_CHANGE` · Seller Central · listing context
...
function handle(event, context) {
  // No-op by default. Brand content changes are recorded automatically.
  // Add your custom logic here (e.g. alert on title or image changes).
  return context;
}
```
...
| `NotificationType` | string | `BRANDED_ITEM_CONTENT_CHANGE` |
| `NotificationVersion` | string | `1.0` |
| `Payload` | object |  |
| `Payload.Asin` | string | `B00EXAMPLE01` |
| `Payload.AttributesChanged` | array |  |
| `Payload.BrandName` | string | `Example Brand` |
| `Payload.MarketplaceId` | string | `ATVPDKIKX0DER` |
